...
//    private static $numeric = '0123456789'; //数字
    ...
    public static function string($minLength=10, $maxLength = 0)
    {
        return self::generate($minLength, $maxLength, self::$string);
    }

    public static function letters($minLength=10, $maxLength = 0)
    {
        return self::generate($minLength, $maxLength, self::$letters);
    }

    public static function chars($minLength=10, $maxLength = 0)
    {
