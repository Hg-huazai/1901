  ...
  <div>
    <div class="pay-order-header">
		...
		<table width="100%" class="bg-fff order-det-cont" >
			<tbody>
				<tr class="orderaddr"  style="border-bottom: solid 8px #f1f1f1;">
          <td align="left" class="padl3">收货地址</td>
					<td align="right" width="50%">{{orderaddress.address}}</td>	
				</tr>
				<tr>
            ...
            <div>￥{{item.foodprice}}</div>
				...
				<tr style="border-top: solid 8px #f1f1f1;">
					...
					<td align="right" class="padr3">
						<a class="padding-right23 colorf00">￥{{foodprice}}</a>
					</td>
				</tr>			
			</tbody>
		</table>
      ...
      <router-link class="paybutton-right fr" style="width: 40%;text-align: center;" to="/orderlist">
          返回
      </router-link>
